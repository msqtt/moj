...
func InitializeApplication() *App {
	...
	server := svc.NewServer(gameViewDao, signUpScoreDao, commandInvoker, gameRepository, createGameCmdHandler, modifyGameCmdHandler, signupGameCmdHandler, cancelSignUpGameCmdHandler, recordRepository)
